...
class SiteSettings(Base):
    ...
    site_name: Mapped[str] = mapped_column(String(100), nullable=False, default="Exchange")
    ...
    app_android_qr_url: Mapped[Optional[str]] = mapped_column(String(500), nullable=True)
    app_ios_qr_url: Mapped[Optional[str]] = mapped_column(String(500), nullable=True)
    app_download_title: Mapped[Optional[str]] = mapped_column(String(255), nullable=True)
    app_download_title_i18n: Mapped[Optional[dict[str, Any]]] = mapped_column(JSON, nullable=True)
    app_download_subtitle: Mapped[Optional[str]] = mapped_column(String(500), nullable=True)
    app_download_subtitle_i18n: Mapped[Optional[dict[str, Any]]] = mapped_column(JSON, nullable=True)
