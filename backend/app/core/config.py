...
class Settings(BaseSettings):
    ...
    COOKIE_DOMAIN: Optional[str] = None   # 线上可设 ".service.example"；本地保持 None
    COOKIE_SECURE: bool = False           # 线上 https 必须 True
    COOKIE_SAMESITE: str = "lax"          # "lax" | "none"
    COOKIE_PATH: str = "/"
    CORS_ORIGINS: Optional[str] = None
    CORS_ALLOW_ORIGINS: str = "http://localhost:3000,http://127.0.0.1:3000,http://192.168.31.57:3000,https://sample-hook.zaf.cpolar.io"
    ...
    CONTRACT_PROVIDER_WS_KLINE_ENABLED: bool = True
    ...
    SPOT_PROVIDER_WS_KLINE_HEALTH_TIMEOUT_MS: int = 15000
    SPOT_PROVIDER_WS_KLINE_HEALTH_STARTUP_GRACE_MS: int = 15000
