...
_SITE_SETTINGS_SAFE_LOAD_COLUMNS = (
    ...
    SiteSettings.app_android_qr_url,
    SiteSettings.app_ios_qr_url,
    SiteSettings.app_download_title,
    SiteSettings.app_download_subtitle,
...
SITE_SETTINGS_I18N_FIELDS = {
    ...
    "app_download_title": "app_download_title_i18n",
    "app_download_subtitle": "app_download_subtitle_i18n",
}
