...
from app.services.evm_wallet import derive_evm_private_key_by_chain  # noqa: E402
...
def audit_rows(rows: Iterable[Mapping[str, Any]]) -> Dict[str, Any]:
    ...
    for row in rows:
        ...
        try:
            private_key = derive_evm_private_key_by_chain(int(user_id), chain_key)
...
def print_report(result: Mapping[str, Any]) -> None:
    print("audit_derived_private_key_addresses")
