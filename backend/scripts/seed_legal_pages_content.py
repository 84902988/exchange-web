...
在某些司法管辖区开展的数字资产活动可能不受监管或受到的监管有限。与 Exchange 无关的任何有关当局的任何监管变化或行动都可能对数字资产的使用、转让、交换和价值产生不利影响。用户所在国政府可能会认定用户交易数字资产为非法行为。

请阅读我们的风险披露，了解有关访问平台和/或使用服务相关风险的更多信息。但需注意，该文件并未解释可能出现的所有风险，或这些风险与您自身情况的关系。在访问平台和/或使用服务之前，您应充分了解所涉及的风险。

Exchange 与您在使用服务时进行的任何交易（定义见下文）或其他活动不存在任何信托关系或义务。我们不是您的经纪人、中介、代理或顾问，我们不提供任何形式的金融、投资或咨询建议，我们向您提供的任何通信或信息都不被视为且不应被视为任何形式的建议。

您需知悉，使用服务的风险由您自行承担，并由您根据自己的具体投资目标、财务状况、风险承受能力、投资经验、知识和需求，对服务是否适合您进行独立审视和评估。您应自行为任何亏损或债务负责。我们不建议购买、赚取、出售或持有任何数字资产。在购买、出售或持有任何数字资产之前，请自行进行尽职调查，如有必要，请咨询您的财务、税务和其他顾问。 Exchange 采取合理措施确保网站信息的准确性。对于您在购买、出售或持有数字资产方面的任何损失，包括但不限于因使用或依赖我们提供的此类信息而直接或间接造成的任何损失，我们概不负责。"""

DEFAULT_DOCX_DIR = Path.home() / "Downloads" / "Telegram Desktop"
DEFAULT_TERMS_DOCX = DEFAULT_DOCX_DIR / "使用条款.docx"
DEFAULT_PRIVACY_DOCX = DEFAULT_DOCX_DIR / "Exchange 隐私声明.docx"
PAGE_TITLES_ZH = {
    "risk": "风险提示",
    "terms": "服务条款",
    "privacy": "隐私政策",
