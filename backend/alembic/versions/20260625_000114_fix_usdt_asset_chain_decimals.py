"""fix usdt asset chain decimals

Revision ID: 20260625_000114
Revises: 20260625_000113
...
revision = "20260625_000114"
down_revision = "20260625_000113"
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    ...
    for chain_key, decimals in USDT_CHAIN_DECIMALS.items():
        op.execute(
            sa.text(
                """
