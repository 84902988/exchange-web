...
export const helpCategories: HelpCategory[] = [
  {
    ...
    articles: [
        ...
        sections: [
          {
            heading: zh("注册流程"),
            steps: [
              zh("访问 Exchange 官方网站，确认网址无误后点击注册。"),
      ...
      },
      {
        ...
        sourceFiles: ["如何重置我的 Exchange 帐户密码.docx", "如何修改我的 Exchange 帐户密码.docx"],
        tags: ["密码", "重置", "安全"],
        hot: true,
        sections: [
          {
      ...
      },
      {
        ...
        sourceFiles: ["如何更改我的 Exchange 帐户的电子邮件地址.docx", "如何重置我的账户的手机号码.docx"],
        tags: ["邮箱", "手机号", "安全项"],
        sections: [
          {
            heading: zh("修改邮箱"),
      ...
      },
      {
        ...
        sourceFiles: ["如何更改我的 Exchange 账户的资金密码.docx"],
        tags: ["资金密码", "提现", "安全"],
        sections: [
          {
      ...
      },
      {
        ...
        sourceFiles: ["如何找回无法访问的 Exchange 账户.docx", "当多个安全项丢失时.docx", "如何处理未收到验证邮件的情况.docx"],
        tags: ["账户恢复", "验证码", "安全项"],
        hot: true,
        sections: [
          {
      ...
      },
      {
        ...
        sourceFiles: ["如何注销我的 Exchange 账户.docx"],
        tags: ["注销", "账户"],
        sections: [
          {
            heading: zh("注销前确认"),
  ...
  },
  {
    ...
    articles: [
      ...
      },
      {
        ...
        sourceFiles: ["如何完成 Exchange 账户的身份认证.docx", "如何录制验证视频.docx"],
        tags: ["个人认证", "证件", "视频验证"],
        sections: [
          {
            heading: zh("认证步骤"),
      ...
      },
      {
        ...
        sourceFiles: ["如何完成 Exchange 账户的企业认证.docx", "KYB 常见问题.docx"],
        tags: ["KYB", "企业认证", "机构账户"],
        sections: [
          {
            heading: zh("企业认证流程"),
      ...
      },
      {
        ...
        sourceFiles: ["Exchange 账户提交企业认证需要哪些文件.docx", "KYB 常见问题.docx"],
        tags: ["KYB", "文件", "企业"],
        sections: [
          {
            heading: zh("常见企业文件"),
    ...
    articles: [
      {
        ...
        sourceFiles: ["如何在 Exchange 上充值加密货币.docx"],
        tags: ["充值", "链上", "网络"],
        hot: true,
        sections: [
          {
      ...
      },
      {
        ...
        sourceFiles: ["如何从 Exchange 提现加密货币.docx"],
        tags: ["提现", "链上", "资金密码"],
        hot: true,
        sections: [
          {
        ...
        sections: [
          {
            heading: zh("如何选择网络"),
            bullets: [
              zh("转出平台、钱包和 Exchange 充值页面必须选择同一网络。"),
              zh("提现时请确认目标地址支持所选网络。"),
              zh("不同网络手续费和到账时间可能不同。"),
            ],
          },
      ...
      },
      {
        ...
        sourceFiles: ["如何在 Exchange 上进行内部转账.docx", "如何在 Exchange 账户之间划转资产.docx"],
        tags: ["划转", "内部转账", "资产"],
        sections: [
          {
            heading: zh("账户划转"),
  ...
  },
  {
    ...
    articles: [
      ...
      },
      {
        ...
        title: zh("官方渠道验证"),
        summary: zh("通过官方验证工具核查网站、邮箱或社媒账号是否属于 Exchange。"),
        sourceFiles: ["如何验证 Exchange 官方渠道并举报可疑链接.docx"],
        tags: ["官方渠道", "举报", "验证"],
        sections: [
          {
            heading: zh("验证方式"),
            steps: [
              zh("打开 Exchange 官方验证工具。"),
    ...
    articles: [
      {
        ...
        sourceFiles: ["Exchange 隐私声明.docx"],
        tags: ["隐私", "数据", "政策"],
        sections: [
          {
            heading: zh("主要内容"),
